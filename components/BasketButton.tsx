...
export function BasketButton({ className = "" }: { className?: string }) {
  ...
  return (
    <Link
      ...
      className={`relative inline-flex items-center justify-center w-11 h-11 rounded-full border border-[color:var(--border)] hover:border-[color:var(--accent)] hover:bg-[color:var(--accent)]/5 transition-colors ${className}`}
    >
