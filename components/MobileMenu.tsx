...
export function MobileMenu({ links }: { links: NavLink[] }) {
  ...
  return (
    <details ref={ref} className="lg:hidden relative">
      {/* p-2.5 takes the 24px icon to a 44×44 hit area; the matching -m-2.5 keeps
          the header's visual alignment unchanged. */}
      <summary className="list-none cursor-pointer p-2.5 -m-2.5" aria-label="Open menu">
